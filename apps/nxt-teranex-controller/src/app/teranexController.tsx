...
export function TeranexController() {
    ...
    const handleDeviceCommandResult = useCallback((result: string) => {
        ...
        const panelLock = panelLockIndex ? result.substring(panelLockIndex + 12, panelLockIndex + 17) === "true" : false;
    ...
    const handleVideoInputCommandResult = useCallback((result: string) => {
    ...
    const handleVideoOutputCommandResult = useCallback((result: string) => {
    ...
    }, [handleDeviceCommandResult, handleVideoInputCommandResult, handleVideoOutputCommandResult, handleAncillaryDataCommandResult]);
    ...
    const handleSetupChanged = useCallback((type: string) => (event: SyntheticEvent<HTMLButtonElement>) => {
        ...
        <div className="teranex-container">
            <div className="teranex">
                <div className="teranex-block">
                    ...
                    <button data-mode={'in'} disabled={teranex.mode === null} onClick={handleTypeChanged}
                            className={clsx(
                                "teranex-button",
                    ...
                    <div className="teranex-logo">
                        NXT
                    </div>
                    <button data-mode={'out'} disabled={teranex.mode === null} onClick={handleTypeChanged}
                            className={clsx(
                                "teranex-button",
                                teranex.mode === null && "disabled",
                ...
                <div className={"teranex-block"}>
                    ...
                    <button disabled={teranex.mode === "out"}
                            ...
                            data-video={'hdmi'} onClick={handleSetupChanged('video')}
                    >
                        HDMI
                    </button>
                    <button disabled={teranex.mode === "out"}
                            ...
                            data-video={'opt'} onClick={handleSetupChanged('video')}
                    >
                        OPT
                    </button>
                </div>
                <div className={"teranex-block"}>
                    ...
                    <button disabled={teranex.mode === "out"}
                            className={clsx(
                                ...
                                teranex.mode === "in" && teranex.audio !== "embed" && command.audio === "embed" && "selected",
                            )}
                            data-audio={'embed'} onClick={handleSetupChanged('audio')}
                    >
                        EMBED
                    </button>
                    <button disabled={teranex.mode === "out"}
                            ...
                            data-audio={'aes'} onClick={handleSetupChanged('audio')}
                    >
                        AES
                    </button>
                    <button disabled={teranex.mode === "out"}
                            ...
                            data-audio={'anlg'} onClick={handleSetupChanged('audio')}
                    >
                        ANLG
                    </button>
                </div>
                <div className={"teranex-block"}>
                    <div className="teranex-title teranex-title-border">
                        Format
                    </div>
                    <ul className={"teranex-group"}>
                        <li>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        "teranex-button",
                                        teranex.mode === "out" ? teranex.format === "486" && "active" : "disabled",
                                        teranex.mode === "out" && teranex.format !== "486" && command.format === "486" && "selected",
                                    )}
                                    data-format={'486'} onClick={handleSetupChanged('format')}
                            >
                                486
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.format !== "720" && command.format === "720" && "selected",
                                    )}
                                    data-format={'720'} onClick={handleSetupChanged('format')}
                            >
                                720
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.format !== "2k" && command.format === "2k" && "selected",
                                    )}
                                    data-format={'2k'} onClick={handleSetupChanged('format')}
                            >
                                2K
                            </button>
                        </li>
                        <li>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.format !== "576" && command.format === "576" && "selected",
                                    )}
                                    data-format={'576'} onClick={handleSetupChanged('format')}
                            >
                                576
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.format !== "1080" && command.format === "1080" && "selected",
                                    )}
                                    data-format={'1080'} onClick={handleSetupChanged('format')}
                            >
                                1080
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.format !== "ultraHd" && command.format === "ultraHd" && "selected",
                                    )}
                                    data-format={'ultraHd'} onClick={handleSetupChanged('format')}
                            >
                                ULTRA HD
                            </button>
                        </li>
                ...
                <div className={"teranex-block"}>
                    ...
                    <button disabled={teranex.mode === "in"}
                            ...
                            data-frame={'p'} onClick={handleSetupChanged('frame')}
                    >
                        P
                    </button>
                    <button disabled={teranex.mode === "in"}
                            ...
                            data-frame={'i'} onClick={handleSetupChanged('frame')}
                    >
                        I
                    </button>
                    <button disabled={teranex.mode === "in"}
                            ...
                            data-frame={'psf'} onClick={handleSetupChanged('frame')}
                    >
                        PSF
                    </button>
                </div>
                        ...
                        <li>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.rate !== "23.98" && command.rate === "23.98" && "selected",
                                    )}
                                    data-rate={'23.98'} onClick={handleSetupChanged('rate')}
                            >
                                23.98
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.rate !== "29.97" && command.rate === "29.97" && "selected",
                                    )}
                                    data-rate={'29.97'} onClick={handleSetupChanged('rate')}
                            >
                                29.97
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.rate !== "59.94" && command.rate === "59.94" && "selected",
                                    )}
                                    data-rate={'59.94'} onClick={handleSetupChanged('rate')}
                            >
                                59.94
                            </button>
                        </li>
                        <li>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.rate !== "24" && command.rate === "24" && "selected",
                                    )}
                                    data-rate={'24'} onClick={handleSetupChanged('rate')}
                            >
                                24
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.rate !== "30" && command.rate === "30" && "selected",
                                    )}
                                    data-rate={'30'} onClick={handleSetupChanged('rate')}
                            >
                                30
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.rate !== "60" && command.rate === "60" && "selected",
                                    )}
                                    data-rate={'60'} onClick={handleSetupChanged('rate')}
                            >
                                60
                            </button>
                        </li>
                        <li>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.rate !== "25" && command.rate === "25" && "selected",
                                    )}
                                    data-rate={'25'} onClick={handleSetupChanged('rate')}
                            >
                                25
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.rate !== "50" && command.rate === "50" && "selected",
                                    )}
                                    data-rate={'50'} onClick={handleSetupChanged('rate')}
                            >
                                50
                            </button>
                        </li>
                        ...
                        <li>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.aspect !== "anam" && command.aspect === "anam" && "selected",
                                    )}
                                    data-aspect={'anam'} onClick={handleSetupChanged('aspect')}
                            >
                                ANAM
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.aspect !== "lbox-pbox" && command.aspect === "lbox-pbox" && "selected",
                                    )}
                                    data-aspect={'lbox-pbox'} onClick={handleSetupChanged('aspect')}
                            >
                                LBOX PBOX
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.aspect !== "smart" && command.aspect === "smart" && "selected",
                                    )}
                                    data-aspect={'smart'} onClick={handleSetupChanged('aspect')}
                            >
                                SMART
                            </button>
                        </li>
                        <li>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.aspect !== "14:9" && command.aspect === "14:9" && "selected",
                                    )}
                                    data-aspect={'14:9'} onClick={handleSetupChanged('aspect')}
                            >
                                14:9
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.aspect !== "ccut-zoom" && command.aspect === "ccut-zoom" && "selected",
                                    )}
                                    data-aspect={'ccut-zoom'} onClick={handleSetupChanged('aspect')}
                            >
                                CCUT ZOOM
                            </button>
                            <button disabled={teranex.mode === "in"}
                                    className={clsx(
                                        ...
                                        teranex.mode === "out" && teranex.aspect !== "adj" && command.aspect === "adj" && "selected",
                                    )}
                                    data-aspect={'adj'} onClick={handleSetupChanged('aspect')}
                            >
                                ADJ
                            </button>
                        </li>
                ...
                <div className="teranex-block stretch">
                    <div>
                        <div className={"teranex-title"}>
                            AUDIO STATUS
                        </div>
                        <ul className="teranex-group horizontal">
                            <li>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["1"] && "active")}>1
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["2"] && "active")}>2
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["3"] && "active")}>3
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["4"] && "active")}>4
                                </button>
                            </li>
                            <li>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["5"] && "active")}>5
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["6"] && "active")}>6
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["7"] && "active")}>7
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["8"] && "active")}>8
                                </button>
                            </li>
                            <li>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["9"] && "active")}>9
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["10"] && "active")}>10
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["11"] && "active")}>11
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["12"] && "active")}>12
                                </button>
                            </li>
                            <li>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["13"] && "active")}>13
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["14"] && "active")}>14
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["15"] && "active")}>15
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.audioStatus["16"] && "active")}>16
                                </button>
                            </li>
                        </ul>
                    </div>
                    <div style={{marginTop: '.6rem'}}>
                        ...
                        <ul className="teranex-group horizontal">
                            <li>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.systemStatus.vid && "active")}>
                                    VID
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.systemStatus.ref && "active")}>
                                    REF
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.systemStatus.ps && "active")}>
                                    PS
                                </button>
                            ...
                            <li>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.systemStatus.tc && "active")}>
                                    TC
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.systemStatus.cc && "active")}>
                                    CC
                                </button>
                                <button
                                    className={clsx("teranex-button small uncontrolled", teranex.systemStatus.eth && "active")}>
                                    &#8672;&#8674;
                                </button>
                                <button className="teranex-button small uncontrolled"/>
                            </li>
                ...
                <div className={"teranex-block"}>
                    <div className={"teranex-title"}>&nbsp;</div>
                    <button disabled={teranex.mode === null}
                            className={clsx(
                                "teranex-button",
                                teranex.mode === null && "disabled",
                    ...
                    <button disabled={teranex.mode === null || processingCommand !== null}
                            className={clsx(
                                "teranex-button",
                                (teranex.mode === null || processingCommand !== null) && "disabled",
                                teranex.mode === "in" && ((command.video && command.video !== teranex.video) || (command.audio && command.audio !== teranex.audio)) && "selected",
                                teranex.mode === "out" && ((command.format && command.format !== teranex.format) || (command.frame && command.frame !== teranex.frame) || (command.rate && command.rate !== teranex.rate) || (command.aspect && command.aspect !== teranex.aspect)) && "selected",
                            )}
                            onClick={handleApply}
                    >
                        APPLY
